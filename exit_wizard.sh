...
adb shell pm enable org.leafos.setupwizard/org.lineageos.setupwizard.SetupWizardExitActivity || true
if [[ ! -z "$has_google_suw" ]]
then
    wait ${!}
...
sleep 1
adb shell am start org.leafos.setupwizard/org.lineageos.setupwizard.SetupWizardExitActivity || true
if [[ ! -z "$has_google_suw" ]]
then
    wait ${!}
    sleep 1
